...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/tools/Xilinx/Vitis_HLS/2021.2/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 154 "/tools/Xilinx/Vitis_HLS/2021.2/common/technology/autopilot/etc/autopilot_ssdm_op.h"
extern "C" {
...
# 1 "/tools/Xilinx/Vitis_HLS/2021.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 1 3 4
# 62 "/tools/Xilinx/Vitis_HLS/2021.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 3 4
typedef long unsigned int size_t;
# 34 "/usr/include/stdio.h" 2 3 4


# 1 "/tools/Xilinx/Vitis_HLS/2021.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 1 3 4
# 30 "/tools/Xilinx/Vitis_HLS/2021.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 48 "/tools/Xilinx/Vitis_HLS/2021.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 3 4
...
# 1 "/tools/Xilinx/Vitis_HLS/2021.2/common/technology/autopilot/hls_stream.h" 1
# 61 "/tools/Xilinx/Vitis_HLS/2021.2/common/technology/autopilot/hls_stream.h"
# 1 "/tools/Xilinx/Vitis_HLS/2021.2/common/technology/autopilot/hls_stream_39.h" 1
# 72 "/tools/Xilinx/Vitis_HLS/2021.2/common/technology/autopilot/hls_stream_39.h"
namespace hls {
# 94 "/tools/Xilinx/Vitis_HLS/2021.2/common/technology/autopilot/hls_stream_39.h"
...
# 62 "/tools/Xilinx/Vitis_HLS/2021.2/common/technology/autopilot/hls_stream.h" 2
# 3 "./CNN.h" 2
# 1 "/tools/Xilinx/Vitis_HLS/2021.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 1 3
# 63 "/tools/Xilinx/Vitis_HLS/2021.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 3
...
# 64 "/tools/Xilinx/Vitis_HLS/2021.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 2 3
# 4 "./CNN.h" 2
...
__attribute__((sdx_kernel("CNN", 0))) void CNN( int padding, int width, int hight, data_t *image, data_t *output_conv1, data_t *output_pooling1, data_t *output_conv2);
...
INPUT_DATA_TYPE width_t = CONV_DATA_XSIZE + 2*CONV_PADDING_SIZE;
 ...
 VITIS_LOOP_43_1: for ( int num_channel = 0 ; num_channel < CONV_NUM_CHANNEL ; num_channel ++ ){
      VITIS_LOOP_44_2: for( int num_ker= 0 ; num_ker < CONV_NUM_KERNEL ; num_ker ++){
Push_pixel: for( int i = 0 ; i < hight_t ; i++ ) {
    VITIS_LOOP_46_3: for( int j = 0 ; j < width_t; j++ ) {
...
Shift_win_right:for( int b = 0 ; b < width_t - 2 ; b++) {
        VITIS_LOOP_69_4: for( int n = 0 ; n < 3; n++) {
...
INPUT_DATA_TYPE sum = 0;
          VITIS_LOOP_85_5: for (int m = 0; m < KERNEL_XSIZE; m++) {
             VITIS_LOOP_86_6: for (int n = 0; n < KERNEL_YSIZE; n++) {
...
static void max_pooling(int width, int height, DATA_IN_TYPE *input, DATA_OUT_TYPE *output) {
    ...
    VITIS_LOOP_118_1: for (int num_channel = 0; num_channel < NUM_CHANNEL; num_channel++) {
        VITIS_LOOP_119_2: for (int i = 0; i < height; i += STRIDE_SIZE) {
            VITIS_LOOP_120_3: for (int j = 0; j < width; j += STRIDE_SIZE) {
                VITIS_LOOP_121_4: for (int k = 0; k < POOLING_SIZE; k++) {
                ...
                if (i + POOLING_SIZE - 1 < height && j + POOLING_SIZE - 1 < width) {
                    ...
                    VITIS_LOOP_128_5: for (int a = 0; a < POOLING_SIZE; a++) {
                        VITIS_LOOP_129_6: for (int b = 0; b < POOLING_SIZE; b++) {
...
void upsampling(int width, int height, DATA_IN_TYPE *in_us1, DATA_OUT_TYPE *out_us1) {
    ...
    VITIS_LOOP_154_1: for (int num_channel = 0; num_channel < NUM_CHANNEL; num_channel++) {
        VITIS_LOOP_155_2: for (int i = 0; i < UPSAMPLING_FACTOR_X * height; i++) {
            VITIS_LOOP_156_3: for (int j = 0; j < UPSAMPLING_FACTOR_Y * width; j++) {
                if (i % 2 == 0) {
