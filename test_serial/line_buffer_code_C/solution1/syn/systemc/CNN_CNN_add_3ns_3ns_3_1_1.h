...
// ==============================================================
#ifndef __CNN_CNN_add_3ns_3ns_3_1_1__HH__
#define __CNN_CNN_add_3ns_3ns_3_1_1__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(CNN_CNN_add_3ns_3ns_3_1_1) {
    ...
    SC_CTOR(CNN_CNN_add_3ns_3ns_3_1_1):  ACMP_add_comb_U ("ACMP_add_comb_U") {
