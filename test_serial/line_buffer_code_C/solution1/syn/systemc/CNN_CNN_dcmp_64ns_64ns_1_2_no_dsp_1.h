...
// ==============================================================
#ifndef __CNN_CNN_dcmp_64ns_64ns_1_2_no_dsp_1__HH__
#define __CNN_CNN_dcmp_64ns_64ns_1_2_no_dsp_1__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(CNN_CNN_dcmp_64ns_64ns_1_2_no_dsp_1) {
    ...
    SC_CTOR(CNN_CNN_dcmp_64ns_64ns_1_2_no_dsp_1):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
