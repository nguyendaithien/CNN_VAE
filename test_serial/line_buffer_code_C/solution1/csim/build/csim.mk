...
HLS_SOURCES = ../../../../test.cpp ../../../../model.cpp

TARGET := csim.exe

AUTOPILOT_ROOT := /tools/Xilinxs/Vitis/2019.2
...
$(ObjDir)/model.o: ../../../../model.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../model.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/model.d
